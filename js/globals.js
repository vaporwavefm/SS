...
let pupspr_arr = [ice_pupspr, fire_pupspr]; // this is for the Power Up Image objects

let player1_ship = new Ship(kirbySS, 30, 20, 50, 50,10); // define your Player 1 ship
